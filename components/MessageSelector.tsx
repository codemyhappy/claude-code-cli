...
import { type DiffStats, fileHistoryCanRestore, fileHistoryEnabled, fileHistoryGetDiffStats } from '/utils/fileHistory';
...
import type { Output as FileWriteToolOutput } from '/tools/FileWriteTool/FileWriteTool';
