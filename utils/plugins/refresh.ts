...
import { getAgentDefinitionsWithOverrides } from '../../tools/AgentTool/loadAgentsDir'
import type { PluginError } from '../../types/plugin'
import { logForDebugging } from '../debug'
import { errorMessage } from '../errors'
import { logError } from '../log'
import { clearAllCaches } from './cacheUtils'
import { getPluginCommands } from './loadPluginCommands'
import { loadPluginHooks } from './loadPluginHooks'
import { loadPluginLspServers } from './lspPluginIntegration'
import { loadPluginMcpServers } from './mcpPluginIntegration'
import { clearPluginCacheExclusions } from './orphanedPluginFilter'
