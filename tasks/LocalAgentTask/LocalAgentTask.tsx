...
import { OUTPUT_FILE_TAG, STATUS_TAG, SUMMARY_TAG, TASK_ID_TAG, TASK_NOTIFICATION_TAG, TOOL_USE_ID_TAG, WORKTREE_BRANCH_TAG, WORKTREE_PATH_TAG, WORKTREE_TAG } from '../../constants/xml';
import { abortSpeculation } from '../../services/PromptSuggestion/speculation';
import type { AppState } from '../../state/AppState';
import type { SetAppState, Task, TaskStateBase } from '../../Task';
import { createTaskStateBase } from '../../Task';
import type { Tools } from '../../Tool';
import { findToolByName } from '../../Tool';
import type { AgentToolResult } from '../../tools/AgentTool/agentToolUtils';
...
import { createAbortController, createChildAbortController } from '../../utils/abortController';
import { registerCleanup } from '../../utils/cleanupRegistry';
import { getToolSearchOrReadInfo } from '../../utils/collapseReadSearch';
import { enqueuePendingNotification } from '../../utils/messageQueueManager';
import { getAgentTranscriptPath } from '../../utils/sessionStorage';
import { evictTaskOutput, getTaskOutputPath, initTaskOutputAsSymlink } from '../../utils/task/diskOutput';
import { PANEL_GRACE_MS, registerTask, updateTaskState } from '../../utils/task/framework';
import { emitTaskProgress } from '../../utils/task/sdkProgress';
